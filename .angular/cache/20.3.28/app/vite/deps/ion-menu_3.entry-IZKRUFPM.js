...
var MenuButton = class {
  ...
  render() {
    ...
    return h(Host, { key: "dcade732e366f0687d92cb9ce4065b78b0b41d24", onClick: this.onClick, "aria-disabled": disabled ? "true" : null, "aria-hidden": hidden ? "true" : null, class: createColorClasses(color, {
      ...
      "ion-focusable": true
    }) }, h("button", Object.assign({ key: "7c4a449e239679376f38471d95fd602f9caec5f6" }, attrs, { disabled, class: "button-native", part: "native", "aria-label": ariaLabel }), h("span", { key: "8bb5bf453280a66109198c970b678ad800c7a8cf", class: "button-inner" }, h("slot", { key: "7f78b1e7a0695f2bd600d13ca81f50dd8b965726" }, h("ion-icon", { key: "9f67f5bb06b1f03a6e5df9ecbe23ebf69fb40756", part: "icon", icon: menuIcon, mode, lazy: false, "aria-hidden": "true" }))), mode === "md" && h("ion-ripple-effect", { key: "10be7145c614144e94c3cc0b92dc5ee4e1587fe6", type: "unbounded" })));
  }
  get el() {
    return getElement(this);
  }
...
//# sourceMappingURL=ion-menu_3.entry-IZKRUFPM.js.map
