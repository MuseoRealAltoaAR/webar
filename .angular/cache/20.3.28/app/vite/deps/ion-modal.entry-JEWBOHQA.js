...
var Modal = class {
  ...
  setupChildRoutePassthrough() {
    ...
    const hasVisibleContent = Array.from(pageParent.children).some((child) => {
      var _a2;
      return child !== this.el && !(child instanceof HTMLElement && window.getComputedStyle(child).display === "none") && child.tagName !== "TEMPLATE" && child.tagName !== "SLOT" && !(child.nodeType === Node.TEXT_NODE && !((_a2 = child.textContent) === null || _a2 === void 0 ? void 0 : _a2.trim()));
    });
  ...
  render() {
    ...
    return h(Host, Object.assign({
      key: "ab93657f4a5b4c97168d292b398d975e4b5b4af4",
      "no-router": true,
      ...
      */
      ...
      key: "7f66b4fdb3dec61a2b9aec4e9dbacf5d013d637c",
      class: "modal-handle",
    ...
    }), h("slot", { key: "2dfaaebe3d0b2a46be1224c25f9ab89bf1744332", onSlotchange: this.onSlotChange })));
  }
  get el() {
...
//# sourceMappingURL=ion-modal.entry-JEWBOHQA.js.map
