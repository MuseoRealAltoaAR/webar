...
} from "./chunk-HJWEA7EY.js";
import {
  isRTL
} from "./chunk-AZTSWGKZ.js";
import {
  createLockController
} from "./chunk-GIWZDJGC.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-T2HXZEU6.js";
import "./chunk-OEVHOBH2.js";
...
import {
  transition
} from "./chunk-S2FF2TFP.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-7C6WV6Y4.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BRHzoo00-JRQSYBRW.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-Kan2W7sh-J7KC55K5.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-D10mwcw1-GKTJH732.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-B93Gru0Y-U4GKF5NP.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-A62O3Y4Z.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-VHGFK2RB.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
...
var Content = class {
  ...
  render() {
    ...
    this.resize();
    return h(Host, Object.assign({ key: "8c1bc4a4df8698d3884741eb38512dc059210c50", role: isMainContent ? "main" : void 0, class: createColorClasses(this.color, {
      [mode]: true,
    ...
    } }, inheritedAttributes), h("div", { key: "5e7412549b51ef7543d9378ecab9aac6bc461588", ref: (el2) => this.backgroundContentEl = el2, id: "background-content", part: "background" }), fixedSlotPlacement === "before" ? h("slot", { name: "fixed" }) : null, h("div", { key: "33f6fbf7e1e027c7cbd2dda95b487f18dc648cef", class: {
      "inner-scroll": true,
      "scroll-x": scrollX,
      "scroll-y": scrollY,
      overscroll: (scrollX || scrollY) && forceOverscroll
    }, ref: (scrollEl) => this.scrollEl = scrollEl, onScroll: this.scrollEvents ? (ev) => this.onScroll(ev) : void 0, part: "scroll" }, h("slot", { key: "00c8fe7b9e73533c702273c9457d274195d54e98" })), transitionShadow ? h("div", { class: "transition-effect" }, h("div", { class: "transition-cover" }), h("div", { class: "transition-shadow" })) : null, fixedSlotPlacement === "after" ? h("slot", { name: "fixed" }) : null);
  }
  get el() {
    return getElement(this);
  }
...
var Footer = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      const promise = createKeyboardController((keyboardOpen, waitForResize) => __async(this, null, function* () {
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-DQ1q5MgD-36O2GDV7.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
//# sourceMappingURL=ion-app_8.entry-HTTTUKMA.js.map
