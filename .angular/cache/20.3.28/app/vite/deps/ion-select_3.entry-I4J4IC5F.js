...
import {
  ...
  popoverController,
  safeCall
} from "./chunk-P6JIOVDS.js";
import "./chunk-VJ7UFV6P.js";
import {
  createColorClasses,
  getClassMap,
  hostContext
...
var Select = class {
  ...
  render() {
    ...
    }) }, h("label", { key: "d56d89b5b58da2b5eaebada9d1be58ca45c67806", class: "select-wrapper", id: "select-label", onClick: this.onLabelClick, part: "wrapper" }, this.renderLabelContainer(), h("div", { key: "bc8bf089c693781ad5b3a5db76a12223867d748e", class: "select-wrapper-inner", part: "inner" }, h("slot", { key: "e1c12b96f1573eb192608c458ed1f3463174cd89", name: "start" }), h("div", { key: "6ee5e3900d8e462f175649b502ac6faa2f2b9909", class: "native-wrapper", ref: (el2) => this.nativeWrapperEl = el2, part: "container" }, this.renderSelectText(), this.renderListbox()), h("slot", { key: "faeaea34aad412e1458beab95d4b1b9ca7b87c41", name: "end" }), !hasFloatingOrStackedLabel && this.renderSelectIcon()), hasFloatingOrStackedLabel && this.renderSelectIcon(), shouldRenderHighlight && h("div", { key: "aeff51e51c990844869eff9940575ce6b2223135", class: "select-highlight" })), this.renderBottomContent());
  }
  get el() {
...
var SelectPopover = class {
  ...
  render() {
    ...
    return h(Host, { key: "e7449a1ecfcdbf45a79f8e26a00253c4e146448a", class: getIonMode(this) }, h("ion-list", { key: "52abdfc8668c3429a0dcefef8ddedb6647fdd894" }, header !== void 0 && h("ion-list-header", { key: "978e5c03728756feafcc60a0e10e6ec59bf2ae11" }, header), hasSubHeaderOrMessage && h("ion-item", { key: "e93c44e7f07a76def16e4b11f0fb4780d84ed402" }, h("ion-label", { key: "bba1aac43b0bc7f4f00978dd8301985233f3725c", class: "ion-text-wrap" }, subHeader !== void 0 && h("h3", { key: "ad96f6017cf2cc5219540bded2c4f1ca3b532de2" }, subHeader), message !== void 0 && h("p", { key: "3fd038921dc40c4d0c29734433984b279ccaeec3" }, message))), this.renderOptions(options)));
  }
  get el() {
    return getElement(this);
  }
...
//# sourceMappingURL=ion-select_3.entry-I4J4IC5F.js.map
