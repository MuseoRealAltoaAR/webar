...
} from "./chunk-OTD4BJ4N.js";
import "./chunk-QHCX73PG.js";
import {
...
var ActionSheet = class {
  ...
  renderActionSheetButtons(filteredButtons) {
    ...
    return filteredButtons.map((b, index) => {
      ...
      return h("button", Object.assign({}, htmlAttrs, { role: isRadio ? "radio" : void 0, type: "button", id: buttonId, class: Object.assign(Object.assign({}, buttonClass(b)), isRadio && { "action-sheet-selected": isActiveRadio }), onClick: () => {
        if (isRadio) {
          this.selectRadioButton(b);
        }
        this.buttonClick(b);
      }, disabled: b.disabled, tabIndex }), h("span", { class: "action-sheet-button-inner" }, b.icon && h("ion-icon", { icon: b.icon, "aria-hidden": "true", lazy: false, class: "action-sheet-icon" }), b.text), mode === "md" && h("ion-ripple-effect", null));
    });
  }
  render() {
...
//# sourceMappingURL=ion-action-sheet.entry-NIGRWWLH.js.map
