...
var Range = class {
  constructor(hostRef) {
    ...
    this.setupGesture = () => __async(this, null, function* () {
      ...
      if (rangeSlider) {
        this.gesture = (yield import("./index-CfgBF1SE-37FF2VBG.js")).createGesture({
          el: rangeSlider,
          gestureName: "range",
          gesturePriority: 100,
          /**
    ...
    this.setupActivatedObserver = () => {
      ...
      const syncActivated = () => {
        this.activatedKnob = (knobHandleA === null || knobHandleA === void 0 ? void 0 : knobHandleA.classList.contains("ion-activated")) ? "A" : (knobHandleB === null || knobHandleB === void 0 ? void 0 : knobHandleB.classList.contains("ion-activated")) ? "B" : void 0;
      };
  ...
  render() {
    ...
    const pressedKnobName = dualKnobs ? pressedKnob === null || pressedKnob === void 0 ? void 0 : pressedKnob.toLowerCase() : void 0;
    ...
    }, part: "label" }, label !== void 0 ? h("div", { class: "label-text" }, label) : h("slot", { name: "label" })), h("div", { key: "c066804263ab6ae7393f8dcc51184b7198844ffa", class: "native-wrapper" }, h("slot", { key: "7e8ea224d72b3e965dd948bee7e45c1a096b6899", name: "start" }), this.renderRangeSlider(), h("slot", { key: "21f242f6f60ff3adce6a2d90b2d4dac1ceaf6624", name: "end" }))));
  }
  get el() {
...
//# sourceMappingURL=ion-range.entry-4SI7JQCK.js.map
